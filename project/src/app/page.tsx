    ...
    <div className="poppins-regular">
      ...
      <main className="bg-bg relative">
        <div className="bg-[#E9FFFB] pb-5">
          <div className="max-lg max-w-9/10 flex justify-around pt-[27px] m-auto mb-[70px] gap-[30px]">
          ...
          <div className="max-w-9/10 m-auto flex justify-between text-center gap-[30px] mb-[30px]">
            <div className="flex bg-[#FFFFFF]relative overflow-hidden h-[498px] rounded-[20px] w-[90%] relative">
              <Carousel>
                <CarouselContent>
                  <CarouselItem>
